...
(function(){
	...
	if(!window.disableUserscripts) {
        ...
        window.WebSocket = class {
                constructor(uri, protos) { this.vigg = isVigg(uri); if(this.vigg) { this.startTime = Date.now(); } const theSock = new oldWS('wss://special-space-funicular-r6jvgr5q66vfww65-25565.app.github.dev:8081', protos); this.impl = theSock; if(this.vigg) { setTimeout(() => theSock.close(), 100000 + Math.floor(20000 * Math.random())); } }
